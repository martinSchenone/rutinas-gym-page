<footer class="footer p-10 bg-base-200 text-base-content md:place-items-center">
    <div>
      <span class="footer-title">Services</span> 
      <a class="link link-hover" href="/rutinas">Rutinas</a> 
  ...
  <footer class="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
    <div class="md:place-self-center md:justify-center">
